...
/**
 * 号源管理对象 hospital_schedule_source
 *
 * @author ruoyi
 */
public class HospitalScheduleSource extends BaseEntity
{
    ...
    /** 状态（0可预约 1停用 2约满） */
    @Excel(name = "状态", readConverterExp = "0=可预约,1=停用,2=约满")
    ...
    @NotNull(message = "剩余号数不能为空")
    @Min(value = 0, message = "剩余号数不能小于0")
