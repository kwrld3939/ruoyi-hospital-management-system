...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '总院部',       0, 'admin', '15888888888', 'hospital@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '门诊部',       1, 'admin', '15888888888', 'hospital@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '医技部',       2, 'admin', '15888888888', 'hospital@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  100, '0,100',      '行政后勤部',   3, 'admin', '15888888888', 'hospital@example.com', '0', '0', 'admin', sysdate(), '', null);
-- ----------------------------
-- 2、用户信息表
-- ----------------------------
...
insert into sys_user values(2,  101, 'ry',    '若依', '00', 'ry@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
-- 初始化-岗位信息表数据
-- ----------------------------
insert into sys_post values(1, 'sys_admin',  '系统管理员',  1, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(2, 'director',   '院长',        2, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(3, 'doctor',     '门诊医生',    3, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(4, 'nurse',      '护士',        4, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(5, 'registrar',  '挂号收费员',  5, '0', 'admin', sysdate(), '', null, '');
